...
|
*/
Route::get('/loginAz', [HubspotApiController::class, 'loginAz']);
Route::get('/callback', [HubspotApiController::class, 'callback']);
...
Route::middleware([Admin::class])->group(function () {
    // Group of routes protected by the 'Admin' middleware
    ...
    // Add products route
    Route::get('contacts', [ProductController::class, 'create'])->name('contacts');
    // Save products route (POST request)
